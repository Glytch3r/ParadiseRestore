...
function ParadiseDev.TrailerBrake.onTick()
    ...
    if isKeyDown("Brake") and fix == 2 then
        car2:setForceBrake()
    elseif isKeyDown("Brake") and fix == 3 and previousDistance and distance < previousDistance.distance then
